...
var camera, controls, createCube, height, light, mediumCube, render, renderer, scene, smallCube, width;
...
createCube = function(size, r, divs) {
  var divs2, face, geometry, i, material, x_color, y_color, z_color, _i, _len, _ref;
  if (r == null) {
    r = 0;
  }
  if (divs == null) {
